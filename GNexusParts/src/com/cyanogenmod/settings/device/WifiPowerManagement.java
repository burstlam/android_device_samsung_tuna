...
public class WifiPowerManagement implements OnPreferenceChangeListener {
    ...
    public static void restore(Context context) {
        ...
        Utils.writeValue(FILE, sharedPrefs.getString(DevicePreferenceActivity.KEY_WIFI_PM, "0"));
    }
